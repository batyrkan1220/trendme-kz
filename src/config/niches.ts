...
export const NICHE_GROUPS: NicheGroup[] = [
  ...
  },
  {
    ...
    subNiches: [
      ...
      { key: "symptoms", label: "Симптомы и болезни" },
      { key: "dentistry", label: "Стоматология" },
      { key: "pediatrics", label: "Педиатрия" },
      { key: "sleep_health", label: "Сон и здоровье" },
      { key: "folk_medicine", label: "Народная медицина" },
  ...
  },
  {
    ...
    emoji: "🏢",
    subNiches: [
      { key: "apartments", label: "Квартиры" },
      { key: "mortgage", label: "Ипотека" },
      { key: "new_buildings", label: "Новостройки" },
      { key: "house_tours", label: "Обзоры ЖК" },
      { key: "rent", label: "Аренда" },
      { key: "construction", label: "Строительство" },
      { key: "real_estate_invest", label: "Инвестиции в недвижимость" },
    ],
  },
  {
    key: "blogging",
