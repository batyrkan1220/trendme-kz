...
export const NICHE_GROUPS: NicheGroup[] = [
  ...
  },
  {
    ...
    subNiches: [
      ...
      { key: "english", label: "Ағылшын тілі" },
      { key: "school_ent", label: "ЕНТ / Мектеп" },
      { key: "university", label: "Университет" },
      { key: "online_courses", label: "Онлайн курстар" },
      { key: "math_science", label: "Математика / Ғылым" },
      { key: "study_tips", label: "Оқу лайфхактары" },
      { key: "books", label: "Кітаптар / Книги" },
    ],
  },
  {
    key: "gaming",
    ...
    emoji: "🎮",
    subNiches: [
      { key: "mobile_games", label: "Мобильді ойындар" },
      { key: "pc_games", label: "PC ойындар" },
      { key: "console_games", label: "Консольді ойындар" },
      { key: "game_reviews", label: "Ойын обзорлары" },
