...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative flex h-[100dvh] w-full overflow-hidden" style={{ background: "#0a0a0a", color: "#ffffff" }}>
      ...
      <main className="flex-1 min-w-0 h-full pb-0 md:pb-0 overflow-x-hidden overflow-y-auto" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', paddingTop: isNativePlatform ? 'env(safe-area-inset-top, 0px)' : undefined }}>
        {children}
      </main>
