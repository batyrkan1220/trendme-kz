...
const NICHES = [
  { key: "all", label: "Все категории", emoji: "🔥", keywords: [] },
  { key: "auto", label: "Авто", emoji: "🚗", keywords: ["авто", "машин", "мото", "car", "auto", "тачк", "водител", "дтп", "гараж", "көлік"] },
  { key: "beauty", label: "Beauty (Бьюти)", emoji: "💄", keywords: ["бьюти", "косметик", "макияж", "уход", "кожа", "крем", "beauty", "makeup", "skincare", "маникюр", "волос"] },
  { key: "fashion", label: "Мода и стиль", emoji: "👗", keywords: ["мода", "стиль", "одежд", "образ", "outfit", "fashion", "style", "look", "шопинг", "сән"] },
  { key: "travel", label: "Путешествия", emoji: "✈️", keywords: ["путешеств", "travel", "туризм", "отдых", "отпуск", "страна", "город", "поездк", "виз", "саяхат"] },
  { key: "food", label: "Еда / Food", emoji: "🍔", keywords: ["еда", "food", "вкусн", "ресторан", "кафе", "перекус", "тамақ", "фастфуд"] },
  { key: "fitness", label: "Фитнес и здоровье", emoji: "🏋️", keywords: ["фитнес", "спорт", "тренировк", "зал", "похуде", "здоров", "fitness", "workout", "gym", "йог", "жаттығу"] },
  { key: "education", label: "Образование", emoji: "🎓", keywords: ["образован", "учеб", "урок", "язык", "школ", "универ", "курс", "education", "learn", "білім", "ҰБТ"] },
  { key: "business", label: "Бизнес и деньги", emoji: "💼", keywords: ["бизнес", "деньг", "заработ", "финанс", "инвест", "стартап", "business", "money", "кәсіпкерлік"] },
  { key: "realestate", label: "Недвижимость", emoji: "🏠", keywords: ["недвижимост", "квартир", "ипотек", "аренд", "жиль", "realestate", "apartment"] },
  { key: "family", label: "Семья и дети", emoji: "👶", keywords: ["семь", "дет", "ребенок", "малыш", "мам", "родител", "воспитан", "baby", "kids", "бала"] },
  { key: "animals", label: "Животные", emoji: "🐶", keywords: ["животн", "кот", "собак", "питомец", "pet", "cat", "dog", "жануар", "мысық"] },
  { key: "gaming", label: "Игры / Gaming", emoji: "🎮", keywords: ["игр", "game", "gaming", "геймер", "ps5", "xbox", "steam", "компьютер"] },
  { key: "entertainment", label: "Развлечения", emoji: "🎥", keywords: ["развлечен", "шоу", "челлендж", "challenge", "тренд", "вайн", "viral", "entertainment"] },
  { key: "music", label: "Музыка", emoji: "🎶", keywords: ["музык", "песн", "music", "трек", "клип", "концерт", "әуен"] },
  { key: "psychology", label: "Психология и отношения", emoji: "🧠", keywords: ["психолог", "отношен", "любов", "чувств", "эмоци", "relationship", "саморазвит"] },
  { key: "religion", label: "Религия и мотивация", emoji: "🕌", keywords: ["религи", "ислам", "молитв", "мотивац", "дуа", "намаз", "дін", "мешіт", "motivation"] },
  { key: "diy", label: "Дом / Ремонт / DIY", emoji: "🛠", keywords: ["ремонт", "diy", "своими рукам", "дом", "интерьер", "декор", "мебел", "home", "craft"] },
  { key: "tech", label: "Технологии / IT / AI", emoji: "💻", keywords: ["технолог", "it", "ai", "нейросет", "ии", "chatgpt", "программ", "tech", "гаджет", "робот"] },
  { key: "shopping", label: "Покупки / Обзоры товаров", emoji: "🧳", keywords: ["покупк", "обзор", "товар", "распаковк", "aliexpress", "wildberries", "ozon", "review", "unboxing"] },
  { key: "lifestyle", label: "Блоги / Лайфстайл", emoji: "📱", keywords: ["лайфстайл", "lifestyle", "влог", "vlog", "блог", "рутин", "routine", "день"] },
  { key: "humor", label: "Юмор / Мемы", emoji: "😂", keywords: ["юмор", "смешн", "прикол", "мем", "comedy", "funny", "скетч", "ржач"] },
  { key: "podcast", label: "Интервью / Подкасты", emoji: "🎤", keywords: ["интервью", "подкаст", "podcast", "interview", "разговор", "диалог", "эфир"] },
  { key: "marketing", label: "Маркетинг / Реклама", emoji: "📈", keywords: ["маркетинг", "реклам", "smm", "продвиж", "таргет", "контент", "бренд", "marketing"] },
  { key: "medicine", label: "Медицина / Здоровье", emoji: "🩺", keywords: ["медицин", "здоров", "врач", "лечен", "болезн", "симптом", "doctor", "health", "дәрігер"] },
  { key: "art", label: "Искусство / Дизайн", emoji: "🎨", keywords: ["искусств", "дизайн", "рисов", "арт", "art", "design", "творчеств", "художник"] },
  { key: "news", label: "Новости / Общество", emoji: "🏛", keywords: ["новост", "обществ", "политик", "событи", "news", "жаңалық", "қоғам"] },
  { key: "sport", label: "Спорт", emoji: "⚽", keywords: ["спорт", "футбол", "бокс", "мма", "sport", "football", "ufc", "олимпиад"] },
  { key: "books", label: "Книги / Саморазвитие", emoji: "📚", keywords: ["книг", "чтен", "саморазвит", "book", "reading", "кітап", "развит"] },
  { key: "recipes", label: "Рецепты / Кулинария", emoji: "🧑‍🍳", keywords: ["рецепт", "готов", "кухн", "блюд", "выпечк", "торт", "recipe", "cooking", "тағам"] },
  { key: "cinema", label: "Кино / Сериалы", emoji: "🎬", keywords: ["кино", "фильм", "сериал", "movie", "film", "cinema", "актер", "режисс"] },
] as const;
