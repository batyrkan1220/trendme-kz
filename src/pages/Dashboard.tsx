...
export default function Dashboard() {
  ...
  return (
    <AppLayout>
      <div className="px-3 md:p-8 lg:p-12 max-w-3xl mx-auto w-full animate-fade-in pb-32 md:pb-12 overflow-x-hidden min-h-[calc(100dvh-4rem)] flex flex-col justify-center">
        {/* Greeting */}
