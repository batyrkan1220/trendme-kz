...
function Pricing() {
  const plans = [
    {
      name: "Пробный", price: "Пробный", period: "",
      desc: "Для первого знакомства",
      cta: "Начать бесплатно", featured: false,
      features: [
        { ok: true, label: "Анализ видео" },
        { ok: true, label: "AI Сценарий" },
        { ok: true, label: "3 тренда на категорию" },
        { ok: true, label: "5 результатов поиска" },
        { ok: false, label: "Безлимитный поиск" },
        { ok: false, label: "Безлимитные тренды" },
      ],
    },
    {
      name: "1 мес", price: "9 900 ₸", period: "/мес",
      desc: "Для активных креаторов",
      cta: "Выбрать 1 мес", featured: false,
      features: [
        { ok: true, label: "Анализ видео — безлимитно" },
        { ok: true, label: "AI Сценарий — безлимитно" },
        { ok: true, label: "Безлимитные тренды" },
        { ok: true, label: "Безлимитный поиск" },
      ],
    },
    {
      name: "3 мес", price: "25 200 ₸", period: "/3 мес",
      desc: "8 400 ₸ / мес · скидка 15%",
      cta: "Выбрать 3 мес", featured: true, badge: "★ Популярный",
      features: [
        { ok: true, label: "Анализ видео — безлимитно" },
        { ok: true, label: "AI Сценарий — безлимитно" },
        { ok: true, label: "Безлимитные тренды" },
        { ok: true, label: "Безлимитный поиск" },
        { ok: true, label: "Экономия 15%" },
      ],
    },
  ];
...
function FAQ() {
  const faqs = [
    { q: "Можно начать бесплатно без карты?", a: "Да. Тариф «Пробный» доступен бесплатно: анализ видео, AI-сценарии, 3 тренда на категорию и 5 результатов поиска. Карту указывать не нужно." },
