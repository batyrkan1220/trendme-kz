...
const NICHE_QUERIES: Record<string, string[]> = {
  ...
  tattoo: ["тату идеи 2026", "тату мастер", "пирсинг тренд", "#тату", "#пирсинг", "#tattoo", "#ink", "tattoo ideas tiktok", "tattoo viral", "тату қазақша", "#тату_kz", "тату идеялар"],
  career: ["карьера тикток", "фриланс заработок", "удаленная работа", "резюме советы", "#карьера", "#фриланс", "#удаленка", "#career", "#freelance", "#remote", "freelance tips tiktok", "мансап тикток", "фриланс қазақша", "#мансап_kz", "жұмыс іздеу", "қашықтан жұмыс"],
