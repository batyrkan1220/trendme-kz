...
const NICHE_QUERIES: Record<string, string[]> = {
  ...
  business: ["бизнес идеи 2026", "стартап тикток", "продажи онлайн", "предприниматель", "#бизнес", "#стартап", "#business", "#entrepreneur", "business ideas tiktok", "startup viral", "бизнес қазақша", "кәсіпкерлік", "#бизнес_kz", "бизнес идея қазақша", "сауда тикток", "кәсіпкер"],
  psychology: ["психология отношений", "токсичные отношения", "любовь тикток", "свидания советы", "#психология", "#отношения", "#relationship", "relationship advice tiktok", "dating tips viral", "психология қазақша", "қарым-қатынас", "махаббат тикток", "#психология_kz"],
