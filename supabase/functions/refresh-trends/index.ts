...
const NICHE_QUERIES: Record<string, string[]> = {
  ...
  mama: ["мама блог тикток", "материнство", "ребенок развитие", "беременность", "#мамаблог", "#материнство", "#momlife", "#baby", "#parenting", "mom life tiktok viral", "baby tips", "ана блог тикток", "бала тәрбиесі", "#ана_блог", "жүкті ана", "бала дамуы қазақша"],
