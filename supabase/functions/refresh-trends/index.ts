...
const NICHE_QUERIES: Record<string, string[]> = {
  ...
  tattoo: ["тату тикток", "тату идеи", "мини тату", "тату процесс", "#тату", "#tattoo", "#ink", "#tattooideas", "#tattooart", "#inked", "tattoo tiktok", "small tattoo ideas tiktok", "tattoo artist viral", "тату эскиз", "тату мастер тикток", "пирсинг тикток", "#пирсинг", "первое тату тикток", "тату Алматы", "tattoo transformation", "tattoo compilation", "hand tattoo tiktok", "тату девушки", "tattoo meaning"],
