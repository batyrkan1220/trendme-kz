...
const NICHE_QUERIES: Record<string, string[]> = {
  ...
  business: ["бизнес идеи 2026", "стартап тикток", "продажи онлайн", "предприниматель", "#бизнес", "#стартап", "#business", "#entrepreneur", "business ideas tiktok", "startup viral", "бизнес қазақша", "кәсіпкерлік", "#бизнес_kz", "бизнес идея қазақша", "сауда тикток", "кәсіпкер", "малый бизнес тикток", "бизнес с нуля", "small business tiktok", "side hustle 2026", "#smallbusiness", "шағын бизнес", "бизнес жоспар", "#кәсіпкерлік", "бизнес кеңес қазақша", "онлайн сауда қазақша"],
  psychology: ["психология отношений", "токсичные отношения", "любовь тикток", "свидания советы", "#психология", "#отношения", "#relationship", "relationship advice tiktok", "dating tips viral", "психология қазақша", "қарым-қатынас", "махаббат тикток", "#психология_kz", "психолог советы тикток", "как пережить расставание", "манипуляции распознать", "самооценка повысить", "#mentalhealth", "mental health tiktok", "therapy tiktok viral", "психология бала тәрбиесі", "жүйке жүйесі", "#психолог_kz", "өзін-өзі тану"],
  ...
  mama: ["мама блог тикток", "материнство", "ребенок развитие", "беременность", "#мамаблог", "#материнство", "#momlife", "#baby", "#parenting", "mom life tiktok viral", "baby tips", "ана блог тикток", "бала тәрбиесі", "#ана_блог", "жүкті ана", "бала дамуы қазақша", "мама и дочка тикток", "первый ребенок советы", "грудное вскармливание", "#мамажизнь", "newborn tips tiktok", "toddler mom viral", "ана мен бала", "нәресте күтімі", "#ана_kz", "жүктілік қазақша", "бала тамақтандыру"],
  ...
  tattoo: ["тату идеи 2026", "тату мастер", "пирсинг тренд", "#тату", "#пирсинг", "#tattoo", "#ink", "tattoo ideas tiktok", "tattoo viral", "тату қазақша", "#тату_kz", "тату идеялар", "мини тату тикток", "тату на руке идеи", "тату значение", "tattoo artist tiktok", "small tattoo ideas", "#tattooart", "#tattooideas", "#инктату", "тату процесс тикток", "тату Алматы", "тату эскиз 2026", "first tattoo tiktok"],
  career: ["карьера тикток", "фриланс заработок", "удаленная работа", "резюме советы", "#карьера", "#фриланс", "#удаленка", "#career", "#freelance", "#remote", "freelance tips tiktok", "мансап тикток", "фриланс қазақша", "#мансап_kz", "жұмыс іздеу", "қашықтан жұмыс", "собеседование советы тикток", "работа мечты", "подработка студенту", "work from home 2026", "remote job tips", "#workfromhome", "#подработка", "резюме қазақша", "жұмысқа орналасу", "#жұмыс_kz", "мансап кеңес", "IT жұмыс қазақша"],
