...
export const InviteEmail = ({ confirmationUrl }: InviteEmailProps) => (
  <Html lang="ru" dir="ltr">
    <Head />
    <Preview>Вас пригласили в trendme</Preview>
    <Body style={main}>
      <Container style={outer}>
        <Img src={LOGO} width="132" height="36" alt="trendme" style={logo} />
        <Section style={card}>
          <Heading style={h1}>Приглашение в trendme</Heading>
          <Text style={text}>
            Вас пригласили присоединиться к trendme. Нажмите кнопку ниже, чтобы принять приглашение и создать аккаунт.
          </Text>
        ...
        <Text style={footer}>Если вы не ожидали этого приглашения — просто проигнорируйте это письмо.</Text>
