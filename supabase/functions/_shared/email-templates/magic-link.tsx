  ...
  <Html lang="ru" dir="ltr">
    ...
    <Body style={main}>
      <Container style={outer}>
        ...
        <Section style={card}>
          <Heading style={h1}>Войти в trendme</Heading>
          <Text style={text}>
            Нажмите кнопку ниже, чтобы войти в аккаунт. Ссылка действует ограниченное время.
          </Text>
          <Button style={button} href={confirmationUrl}>Войти в trendme</Button>
          <Text style={fallback}>
            Или скопируйте ссылку:<br />
            <Link href={confirmationUrl} style={fallbackLink}>{confirmationUrl}</Link>
          </Text>
        </Section>
        <Text style={footer}>Если вы не запрашивали ссылку — просто проигнорируйте это письмо.</Text>
